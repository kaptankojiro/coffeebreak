...
$HTTP_Response.Close()
Write-Host "Downloading process finished..." -ForegroundColor red -BackgroundColor white
sleep 1
Write-Host "Creating and triggering scheduled task " -ForegroundColor red -BackgroundColor white
